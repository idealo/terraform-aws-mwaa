...
| <a name="input_foo"></a> [foo](#input\_foo) | bar | `string` | `"baz"` | no |
...
| <a name="output_mwaa_security_group_id"></a> [mwaa\_security\_group\_id](#output\_mwaa\_security\_group\_id) | The security group id of the MWAA Environment. |
